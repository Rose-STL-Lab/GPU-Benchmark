...
def load_bj_meo_data(rows_to_load=-1):
    with open('ST-UQ/data/beijing_meo_train_17_18_01.csv', 'r') as data_file:
        next(data_file)
...
def load_bj_aqi_data(rows_to_load=-1):
    with open('ST-UQ/data/beijing_aqi_train_17_18_01.csv', 'r') as data_file:
        next(data_file)
        csv_data = csv.reader(data_file, delimiter=',')
        time_data = {}
        prev_ts = ''
...
def load_bj_aqi_station_locations():
    with open('ST-UQ/data/beijing_aqi_stations.csv', 'r', encoding='UTF-8-sig') as data_file:
        csv_data = csv.reader(data_file, delimiter=',')
        location = {}
...
def load_bj_meo_dev_data():
    with open('ST-UQ/data/beijing_meo_val_02.csv', 'r') as data_file:
        next(data_file)
        csv_data = csv.reader(data_file, delimiter=',')
        time_data = {}
        prev_ts = ''
...
def load_bj_aqi_dev_data():
    ...
    with open('ST-UQ/data/beijing_aqi_val_02.csv', 'r') as data_file:
        next(data_file)
        csv_data = csv.reader(data_file, delimiter=',')
        time_data = {}
        prev_ts = ''
...
def load_bj_meo_test_data():
    with open('ST-UQ/data/beijing_meo_test_03.csv', 'r') as data_file:
        next(data_file)
        csv_data = csv.reader(data_file, delimiter=',')
        time_data = {}
        prev_ts = ''
...
def load_bj_aqi_test_data():
    ...
    with open('ST-UQ/data/beijing_aqi_test_03.csv', 'r') as data_file:
        next(data_file)
        csv_data = csv.reader(data_file, delimiter=',')
        time_data = {}
